...
```hcl
module "signalfx-detectors-integration-aws-ec2" {
  source = "github.com/Cafeine42/terraform-signalfx-detectors.git//modules/integration_aws-ec2?ref={revision}"
